...
An additional cause of the imperfect reproduction may have been the lack of information provided in the original study about how the adaptive capacity data was scaled. In this reproduction, we supposed that the authors may have rescaled the domain from 0 to 1.6 to 0 to 40, but this cannot be confirmed by the original manuscript.
