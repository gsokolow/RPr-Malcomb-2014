...
Aggregating adaptive capacity (assets and access), livelihood sensitivity, and physical exposure is insensitive to outliers. However, the purpose of a vulnerability index is to identify high (and low) priority areas for intervention: essentially, outliers.
...
# Figure Four
data expected for 206 TAs, found for 215, though the main authors found 203 but there were errors.

We expect a Spearman's rank correlation rho for a successful reproduction to have a value of 1. Thus, the Spearman's rho of 0.7891711 (How many digits are really ok to use?), indicates a partially successful reproduction.

Part of the reason for this may be that the authors of the original study did not provide details as to how they scaled their adaptive capacity scores in the process of making figure 4. 
